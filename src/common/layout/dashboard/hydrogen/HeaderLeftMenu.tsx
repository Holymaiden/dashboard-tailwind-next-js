...
import {
  DropdownItemType,
  MenuItemsType,
} from "@/common/layout/dashboard/lithium/MenuItems";
import {
  useFloating,
  flip,
  shift,
...
export function CollapsibleMenu({
  ...
  return (
    <motion.ul
      ...
      className={clsxm("rounded-md border border-gray-300", className)}
    >
  ...
  return (
    <>
      ...
      >
        ...
        <span
          className={clsxm("text-gray-900 duration-200", {
            "text-primary": isActive,
          })}
        >
          <PiCaretDownBold />
